...
@bot.on(poci_cmd(outgoing=True, pattern=r"reserved$"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"name"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"setpfp$"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"setbio (.*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"username (.*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"count$"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(poci_cmd(pattern=r"info(?: |$)(.*)", outgoing=True))
async def who(event):
