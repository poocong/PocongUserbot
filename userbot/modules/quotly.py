...
CMD_HELP.update(
    {
        ...
        \n\n  •  **Syntax :** `{cmd}q` <warna>\
        \n  •  **Function : **Membuat pesan menjadi sticker dengan custom [warna](https://t.me/PocongProject/16) background yang diberikan. list custom warna klik [𝗗𝗜𝗦𝗜𝗡𝗜](https://t.me/PocongProject/16) .\
