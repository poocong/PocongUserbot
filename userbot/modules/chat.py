...
async def kickme(leave):
    ...
    await leave.edit("`User Telah Meninggalkan Grup ツ`")
...
async def mute_chat(mute_e):
    ...
    await mute_e.edit("`Ssshssh User Telah Membisukan Obrolan!`")
    await sleep(2)
    await mute_e.delete()
    if BOTLOG:
...
async def get_chatinfo(event):
    ...
    try:
        ...
        try:
            ...
            await event.edit("`Ini Adalah Grup/Channel Privasi Atau User Dibanned Dari Sana`")
            return None
