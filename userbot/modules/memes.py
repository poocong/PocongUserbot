...
CMD_HELP.update({
    "memes":
    "•**Syntax**: .cowsay"
    "\n•**Function**: sapi yang mengatakan sesuatu."
    "\n\n•**Syntax**: .cp"
    "\n•**Function**: Copy paste meme terkenal"
    "\n\n•**Syntax**:.vapor"
    "\n•**Function**: Menguapkan semuanya!"
    "\n\n•**Syntax**: .str"
    "\n•**Function**: Regangkan."
    "\n\n•**Syntax**: .10iq"
    "\n•**Function**: Kamu mundur !!"
    "\n\n•**Syntax**: .zal"
    "\n•**Function**: Munculkan perasaan kacau."
    "\n\n•**Syntax**: .Oem`"
    "\n•**Function**: Oeeeem"
    "\n\n•**Syntax**: .fp"
    "\n•**Function**: Telapak Tangan:P"
    "\n\n•**Syntax**: .moon"
    "\n•**Function**: animasi bulan."
    "\n\n•**Syntax**: .clock"
    "\n•**Function**: animasi jam."
    "\n\n•**Syntax**: .hi`"
    "\n•**Function**: Sapa semuanya!"
    "\n\n•**Syntax**: .coinflip <Kepala/Ekor>"
    "\n•**Function**: Melempar koin !!"
    "\n\n•**Syntax**: .owo"
    "\n•**Function**: UwU"
    "\n\n•**Syntax**: .react"
    "\n•**Function**: Buat Userbot Anda bereaksi terhadap semuanya."
    "\n\n•**Syntax**: .slap"
    "\n•**Function**: balas tampar mereka dengan benda acak !!"
    "\n\n•**Syntax**: .cry"
    "\n•**Function**: jika kamu melakukan ini, aku akan menangis."
    "\n\n•𝐒𝐲𝐧𝐭𝐚𝐱: .shg"
    "\n•𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧: Angkat bahu!"
    "\n\n•𝐒𝐲𝐧𝐭𝐚𝐱: .run"
    "\n•𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧: Biarkan Aku Lari, Lari, LARI!"
    "\n\n•𝐒𝐲𝐧𝐭𝐚𝐱: .chase"
    "\n•𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧: Sebaiknya Anda mulai berlari"
    "\n\n•𝐒𝐲𝐧𝐭𝐚𝐱: .metoo"
    "\n•𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧: Haha ya"
    "\n\n•𝐒𝐲𝐧𝐭𝐚𝐱: .mock"
    "\n•𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧: Lakukan dan temukan kesenangan yang sesungguhnya."
    "\n\n•𝐒𝐲𝐧𝐭𝐚𝐱: .clap"
    "\n•𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧: Puji orang!"
    "\n\n•𝐒𝐲𝐧𝐭𝐚𝐱: .f <emoji/karakter>"
    "\n•𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧: F."
    "\n\n•𝐒𝐲𝐧𝐭𝐚𝐱: .bt"
    "\n•𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧: Percayalah, Anda akan menemukan ini berguna."
    "\n\n•𝐒𝐲𝐧𝐭𝐚𝐱:.weeb"
    "\n•𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧: Untuk Mengubah Teks Menjadi Weeb-ify."
    "\n\n•𝐒𝐲𝐧𝐭𝐚𝐱: .type <teks>"
    "\n•𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧: Hanya perintah kecil untuk membuat keyboard Anda menjadi mesin tik!"
    "\n\n•𝐒𝐲𝐧𝐭𝐚𝐱: .lfy <query>"
    "\n•𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧: Biar saya Google itu untuk Anda dengan cepat!"
    "\n\n•𝐒𝐲𝐧𝐭𝐚𝐱: .decide [Alternatif: (.yes, .no, .maybe)]"
    "\n•𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧: Buat keputusan cepat."
    "\n\n•𝐒𝐲𝐧𝐭𝐚𝐱: .nou .bot .rock .gey .tf .paw .tai .nih"
    "\n•**Syntax**: .fag .gtfo .stfu .lol .lool .fail .leave"
    "\n•**Syntax**: .iwi .sayhi .koc .gas .earth .love .rain"
    "\n•**Syntax**: .penis .emo .fuck .skull  .monyet \n•𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧: Cobain aja"
