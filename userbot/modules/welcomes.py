...
@bot.on(poci_cmd(outgoing=True, pattern=r"setwelcome(?: |$)(.*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"checkwelcome$"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"rmwelcome$"))
