...
@bot.on(poci_cmd(outgoing=True, pattern=r"anime ?(.*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"manga ?(.*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern="a(kaizoku|kayo) ?(.*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern=r"char ?(.*)"))
...
@bot.on(poci_cmd(outgoing=True, pattern="upcoming$"))
...
@bot.on(poci_cmd(outgoing=True, pattern="whatanime$"))
