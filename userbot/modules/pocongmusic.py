...
async def _(event):
    ...
    if event.pattern_match.group(1):
        ...
        await event.edit("`Apa Yang Harus Saya Cari Tuan?`")
        return
    ...
    await event.edit("`Sedang Mengunggah Lagu Anda Tuan....`")
    c_time = time.time()
...
async def _(event):
    ...
    if event.pattern_match.group(1):
        query = event.pattern_match.group(1)
        await event.edit("`Mohon Menunggu Tuan, Sedang Mencari Musik Anda ヅ`")
    elif reply.message:
        query = reply.message
        await event.edit("`Telah Mendapatkan Musik, Sedang Mengunggah.....ヅ`")
    else:
        await event.edit("`Tuan, Apa Yang Seharusnya Saya Temukan? ヅ`")
        return
...
async def _(event):
    ...
    try:
        async with bot.conversation(chat) as conv:
            ...
            await event.edit("`Memproses... Mohon Menunggu Tuan`")
            try:
