...
from userbot import LOAD_PLUG, bot, GIT_REPO_NAME, GITHUB_ACCESS_TOKEN
import sys
import asyncio
import traceback
import os
...
@command(pattern="^.munload (?P<shortname>\w+)$", outgoing=True)
...
@command(pattern="^.mload (?P<shortname>\w+)$", outgoing=True)
