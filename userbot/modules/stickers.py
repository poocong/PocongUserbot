...
KANGING_STR = [
    "Mengambil Sticker Ini Ke Pack Tuan",
    "Tuan Mengambil Sticker Ini Ke Pack",
]
...
async def kang(args):
    ...
    if photo:
                ...
                while "120" in x.text:
                    ...
                    if x.text == "Gagal Memilih Pack.":
                        ...
                        return await args.edit(
                            ...
                            "\nIni pack yang baru saja Tuan buat!"
                            f"\nTekan [Tuan Sticker](t.me/addstickers/{packname}) Untuk Melihat Sticker Tuan",
                            parse_mode="md",
                        )
                if is_anim:
                    await conv.send_file("AnimatedSticker.tgs")
        ...
        await args.edit(
            f"**Berhasil Menambahkan Sticker Ke Pack, Tekan** **[Tuan Sticker](t.me/addstickers/{packname})** **Untuk Melihat Pack Anda**",
            parse_mode="md",
        )
