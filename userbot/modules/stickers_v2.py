    ...
    async with event.client.conversation(chat) as conv:
          ...
          if response.text.startswith("I understand only stickers"):
              ...
              if response.text.startswith("..."):
                  ...
                  await event.client.delete_messages(conv.chat_id, conv.chat_id, [msg.id, response.id])
              else:
                  await event.edit("try again")
          await bot.send_read_acknowledge(conv.chat_id)
          await event.client.delete_messages(conv.chat_id, conv.chat_id, conv.chat_id, [msg.id, response.id])
