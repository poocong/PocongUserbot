...
async def vc_play(event):
    ...
    if (
        ...
        botpoci = await edit_or_reply(event, "`Searching...`")
        ...
        if search == 0:
            ...
            if hm == 0:
                ...
                try:
                    ...
                    clear_queue(chat_id)
                    await botpoci.edit(f"`{ep}`")

    else:
        botpoci = await edit_or_reply(event, "📥 **Sedang Mendownload**")
